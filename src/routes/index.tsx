  ...
  return (
    <div>
      ...
      <section className="relative h-[100svh] min-h-[600px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-ink-deep via-ink-deep/60 to-ink-deep/10" />
        <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-end px-6 pb-24 pt-32 lg:px-10">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-6 text-5xl font-semibold leading-[1.05] tracking-tight text-white text-balance md:text-7xl [text-shadow:0_2px_24px_rgba(0,0,0,0.6)]">
              Blue Collar Interiors
            </h1>
            <p className="mt-5 max-w-xl text-lg leading-relaxed text-white [text-shadow:0_2px_16px_rgba(0,0,0,0.7)]">
